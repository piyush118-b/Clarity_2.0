...
import { Bell, AlertTriangle, Info, CheckCircle, AlertCircle, Search, Filter, Mail, Trash2, Wrench, Clock, User } from 'lucide-react';
...
export default function ServiceProviderNotificationsPage() {
  ...
  const getActionIcon = (notification: Notification) => {
    ...
    if (content.includes('assignment') || content.includes('assigned')) {
      return <Wrench className="h-4 w-4 text-orange-500" />;
    }
    if (content.includes('urgent') || content.includes('priority')) {
      return <Clock className="h-4 w-4 text-red-500" />;
    }
    if (content.includes('tenant') || content.includes('customer')) {
  ...
  const assignmentNotifications = notifications.filter(n => 
    n.content.toLowerCase().includes('assignment') || 
    n.content.toLowerCase().includes('assigned')
  );
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold">Work Notifications</h1>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{assignmentNotifications.length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
