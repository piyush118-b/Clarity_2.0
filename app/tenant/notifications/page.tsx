...
import { Bell, AlertTriangle, Info, CheckCircle, AlertCircle, Search, Filter, Mail, Trash2, FileText, DollarSign, Wrench } from 'lucide-react';
...
export default function TenantNotificationsPage() {
  ...
  const getActionIcon = (notification: Notification) => {
    ...
    if (content.includes('document') || content.includes('agreement')) {
      return <FileText className="h-4 w-4 text-blue-500" />;
    }
    if (content.includes('payment') || content.includes('charge')) {
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {notifications.filter(n => n.notification_type === 'warning' || n.notification_type === 'alert').length}
                  </p>
                </div>
              </div>
            </CardContent>
